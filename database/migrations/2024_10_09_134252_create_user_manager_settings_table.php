...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user_manager_settings', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(User::class)->comment('Xác định người dùng nào được quyền quản lý chức năng này')->constrained()->onDelete('cascade');
            $table->foreignIdFor(Manager_setting::class)->comment('Xác định chức năng nào')->constrained()->onDelete('cascade');
