    ...
    <div class="card-body">
        <form id="uploadForm" action="{{route('admin.products.store')}}" method="POST" enctype="multipart/form-data">
            <div class="mt-1 d-flex justify-content-end">
                <span class="btn btn-success" id="publishBtn">Đăng</span>
            </div>
            @csrf
                ...
                <div class="d-flex flex-row mt-2 p-3 justify-content-between" id="baseProduct" data-baseproduct="show">
                    <div class="w-50">
                        <div class="mb-3">
                            ...
                            <input type="text" name="sku" class="form-control productSku" placeholder="Nhập mã cho sản phẩm">
                        </div>
                        <div class="mt-3 mb-3">
                            <label for="" class="form-label">Tên sản phẩm</label>
                            <input type="text" name="name" class="form-control productName" placeholder="Nhập tên cho sản phẩm">
                        </div>
                        <div class="mt-3 mb-3">
                            <label for="" class="form-label">Mô tả</label>
                            <textarea name="description" id="productDescription" cols="40" rows="4" class="form-control descriptionProduct" placeholder="Nhập mô tả cho sản phẩm"></textarea>
                        </div>
                        <div class="mt-3 mb-3">
            ...
            <div class="shadow mb-3 bg-body-tertiary rounded">
                ...
                <div class="p-3 d-flex flex-row" id="customVariants" data-customvariants="show">
                    ...
                    <div class="w-50 mr-4">
                        ...
                        <div class="mt-2 border-bottom d-flex flex-row pb-3 pr-3">
                        ...
                        <div id="attributeItems" class="attribute-scroll-container pr-3">
                            <div class="border-bottom attributeItem" >
                                ...
                                <div class="attributeItemContent pb-3" data-status="show">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="d-flex flex-column w-75" style="margin-top:3.2px">
                                            ...
                                            <textarea name="" class="form-control attributeValuesTextarea" rows="3" placeholder="Nhập các tùy chọn để khách hàng lựa chọn, ví dụ: “Green” hoặc “XL”. Sử dụng “|” để phân tách các tùy chọn khác nhau."></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="w-50">
                        ...
                        <div class="mt-2 border-bottom d-flex flex-row pb-3 align-items-center justify-content-between">
                            <div class="d-flex flex-row">
                                <span class="btn btn-primary btn-sm mr-2 no-wrap disabledButton" id="generateVariations">Tạo biến thể tự động</span>
                                <span class="btn btn-primary btn-sm mr-2 no-wrap disabledButton" id="addManually"> Thêm thủ công</span>
                            </div>
                        </div>
                        <p align="center" class="notificationNoVariationsYet">Chưa có biến thể nào. Tạo chúng từ tất cả các thuộc tính đã thêm hoặc thêm biến thể mới theo cách thủ công.</p>
                        <div class="d-flex justify-content-between align-items-center mt-2">
                            ...
                            <div class="d-flex flex-column align-items-end w-25">
                                ...
                                <span class="btn btn-danger btn-sm mt-2 no-wrap deleteAllVariations hidden">Xóa tất cả biến thể</span>
                            </div>
                        </div>
                        <div id="variations" class="pt-2 mt-3 mb-3">
                        ...
                        <div>
                            <span class="btn btn-primary btn-sm checkVariationsStatus hidden">Kiểm tra</span>
                            <span class="btn btn-success btn-sm disabledButton saveVariations hidden">Lưu biến thể</span>
                        </div>
                    </div>
                </div>
            </div>
